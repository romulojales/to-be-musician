...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interpretation.uuid'
        db.add_column(u'songs_interpretation', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interpretation.uuid'
        db.delete_column(u'songs_interpretation', 'uuid')
