...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Song'
        db.create_table(u'musician_song', (
        ...
        db.send_create_signal(u'musician', ['Song'])

        # Adding unique constraint on 'Song', fields ['user', 'song']
        db.create_unique(u'musician_song', ['user_id', 'song_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Song', fields ['user', 'song']
        db.delete_unique(u'musician_song', ['user_id', 'song_id'])

        # Deleting model 'Song'
        db.delete_table(u'musician_song')
    ...
    models = {
        ...
        u'musician.song': {
            'Meta': {'unique_together': "(('user', 'song'),)", 'object_name': 'Song'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
